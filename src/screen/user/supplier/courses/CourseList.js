        ...
        return (
            <Pressable style={styles.itemWrapper} onPress={() => {
                ...
                <View style={styles.itemDetails}>
                    <Text style={styles.itemTitle} numberOfLines={2}>{translate(appLanguage, `${title}`)}</Text>
                    <Text style={styles.itemTags} numberOfLines={3} > {translate(appLanguage, `${description}`)}</Text>
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.main}>
                {courses?.length != 0 && <FlatList
                    ...
                    renderItem={({ item }) => {
                        return (
                            <Item title={item?.title} description={item?.description} price={item?.price} startDate={item?.start_date}
